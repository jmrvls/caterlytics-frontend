  ...
  <div class="min-h-screen flex bg-gray-50 dark:bg-gray-900 font-sans">
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div v-if="activeSection === 'Dashboard' && userRole === 'Staff'">
          ...
          <div class="grid grid-cols-1 md:grid-cols-1 gap-4 mb-8 max-w-sm">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 text-center">
              <h3 class="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wide">Total Revenue</h3>
              <p class="text-3xl font-black text-gray-900 dark:text-gray-100 mt-2">₱{{ formatCurrency(totalRevenue) }}</p>
            </div>
          </div>

          <!-- Quick Action -->
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <button @click="activeSection = 'Payments'" class="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-center gap-3 hover:border-emerald-300 dark:hover:border-emerald-600 hover:bg-emerald-50/40 dark:hover:bg-emerald-900/20 transition text-center">
        ...
        <div v-if="activeSection === 'Dashboard' && userRole !== 'Staff'">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 text-center">
              <h3 class="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wide">Total Bookings</h3>
              <p class="text-3xl font-black text-gray-900 dark:text-gray-100 mt-2">{{ isLoadingDashboard ? '…' : totalBookings }}</p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 text-center">
              <h3 class="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wide">Active Events</h3>
              <p class="text-3xl font-black text-gray-900 dark:text-gray-100 mt-2">{{ isLoadingDashboard ? '…' : activeEventsCount }}</p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 text-center">
              <h3 class="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wide">Low Stock Items</h3>
              <p class="text-3xl font-black text-gray-900 dark:text-gray-100 mt-2">{{ isLoadingDashboard ? '…' : lowStockCount }}</p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 text-center">
              <h3 class="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wide">Total Revenue</h3>
              <p class="text-3xl font-black text-gray-900 dark:text-gray-100 mt-2">₱{{ isLoadingDashboard ? '…' : formatCurrency(totalRevenue) }}</p>
            </div>
          </div>

          <!-- Quick Actions -->
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <button @click="router.push('/admin/bookings')" class="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-center gap-3 hover:border-emerald-300 dark:hover:border-emerald-600 hover:bg-emerald-50/40 dark:hover:bg-emerald-900/20 transition text-center">
              <div class="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-900/30 flex items-center justify-center flex-shrink-0">
                <svg class="w-5 h-5 text-emerald-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button @click="activeSection = 'Inventory'" class="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-center gap-3 hover:border-emerald-300 dark:hover:border-emerald-600 hover:bg-emerald-50/40 dark:hover:bg-emerald-900/20 transition text-center">
            ...
            <button @click="activeSection = 'Staff Management'" class="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-center gap-3 hover:border-emerald-300 dark:hover:border-emerald-600 hover:bg-emerald-50/40 dark:hover:bg-emerald-900/20 transition text-center">
        ...
        <div v-if="activeSection === 'Staff Management'">
          ...
          <div class="flex justify-between items-center mb-4">
            ...
            <button v-if="userRole === 'Admin'" @click="openAddUserModal" class="flex items-center gap-2 bg-emerald-600 text-white px-4 py-2.5 rounded-xl font-semibold text-sm hover:bg-emerald-700 transition">
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
              </svg>
              Add New User
              ...
              <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <tr v-for="u in userList" :key="u.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td class="px-6 py-3.5 text-right">
                    <button v-if="userRole === 'Admin'" @click="openEditUserModal(u)" class="text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:underline">
                      Edit
                    </button>
        ...
        <div v-if="!['Dashboard', 'Staff Management'].includes(activeSection)" class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 text-center text-gray-400 dark:text-gray-500">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <form @submit.prevent="handleCreateUser" class="space-y-4">
          <div>
            ...
            <input type="text" v-model="newUser.full_name" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" required />
          </div>

          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Username</label>
            <input type="text" v-model="newUser.username" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" required />
          </div>

          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Password</label>
            <div class="relative mt-1">
              <input
                :type="showNewPassword ? 'text' : 'password'"
                v-model="newUser.password"
                class="w-full p-3 pr-12 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100"
                required
              />
              <button
                type="button"
          ...
          <div>
            ...
            <input type="text" v-model="newUser.contact_number" placeholder="e.g. 0917 123 4567" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" />
          </div>

          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Role</label>
            <select v-model="newUser.role" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" required>
          ...
          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Availability</label>
            <select v-model="newUser.availability" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" required>
          ...
          <div class="flex gap-3 pt-2">
            <button type="button" @click="closeAddUserModal" class="flex-1 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 py-2.5 rounded-xl font-semibold text-sm hover:bg-gray-50 dark:hover:bg-gray-700">
              Cancel
            </button>
    ...
    <div v-if="showEditUserModal" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <div v-if="editModalError" class="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-sm font-medium p-3 rounded-xl mb-4">
          {{ editModalError }}
        </div>
        ...
        <form @submit.prevent="handleUpdateUser" class="space-y-4">
          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Full Name</label>
            <input type="text" v-model="editUser.full_name" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" required />
          </div>

          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Username</label>
            <input type="text" :value="editUser.username" disabled class="w-full mt-1 p-3 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-500 dark:text-gray-400" />
          </div>

          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Contact Number</label>
            <input type="text" v-model="editUser.contact_number" placeholder="e.g. 0917 123 4567" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" />
          </div>

          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Role</label>
            <select v-model="editUser.role" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" required>
              <option value="Admin">Admin</option>
              <option value="Staff">Staff</option>
              <option value="Owner/Manager">Owner/Manager</option>
            </select>
          ...
          <div>
            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Availability</label>
            <select v-model="editUser.availability" class="w-full mt-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-gray-100" required>
              <option value="Available">Available</option>
              <option value="On Leave">On Leave</option>
              <option value="Unavailable">Unavailable</option>
            </select>
          ...
          <div class="flex gap-3 pt-2">
            <button type="button" @click="closeEditUserModal" class="flex-1 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 py-2.5 rounded-xl font-semibold text-sm hover:bg-gray-50 dark:hover:bg-gray-700">
              Cancel
            </button>
