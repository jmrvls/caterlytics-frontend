      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-row items-center justify-between gap-2 sm:gap-3 mb-4">
          ...
          <div class="flex items-center gap-3 flex-shrink-0">
            ...
            <button @click="openCreateModal" class="flex items-center gap-2 bg-emerald-600 text-white px-3 py-2.5 sm:px-4 rounded-none font-semibold text-sm hover:bg-emerald-700 transition whitespace-nowrap">
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
